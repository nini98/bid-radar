...
class BidTypeRuleTest {
    ...
    void 둘다일치시_만점() {
        // given
        BidNotice bid = bidNotice("일반경쟁", "일반계약");
        CompanyProfileContext profile = profile(List.of("일반경쟁"), List.of("일반계약"));
    ...
    void 하나만일치시_절반점수() {
        // given
        BidNotice bid = bidNotice("일반경쟁", "수의계약");
        CompanyProfileContext profile = profile(List.of("일반경쟁"), List.of("일반계약"));
    ...
    void 둘다불일치시_0점() {
        // given
        BidNotice bid = bidNotice("수의계약", "단독계약");
        CompanyProfileContext profile = profile(List.of("일반경쟁"), List.of("일반계약"));
